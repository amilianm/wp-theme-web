<?php
// Creando el Widget Into con Imágen
class wpb_widget_ici extends WP_Widget {
...
__('MAC - Into con Imágen', 'wpb_widget_domain'), 
 
// Widget description
array( 'description' => __( 'Muestra una Intro con Imágen', 'wpb_widget_domain' ), ) 
);
}
...
$imgin = apply_filters( 'widget_imgin', $instance['imgin'] );
...
if ( ! empty( $title ) )
?>
<section class="header3 cid-introcima" id="introcima" style="padding-top:<?php echo $padto; ?>; padding-bottom:<?php echo $padbo; ?>; opacity: <?php echo $baopa; ?>; background-color: <?php echo $bacol; ?>;">
<div class="container">
  <div class="media-container-row">
    <div class="mbr-figure" style="width: 100%;">
      <img src="<?php bloginfo('template_url'); ?><?php echo $imgin; ?>" alt="">
    </div>
...
$imgin = $instance[ 'imgin' ];
$padto = $instance[ 'padto' ];
$padbo = $instance[ 'padbo' ];
}
else {
$title = __( 'Intro con Imágen', 'wpb_widget_domain' );
$ctitl = __( '#FFFFFF', 'wpb_widget_domain' );
$subti = __( 'Introducción de ancho completo con color de fondo, superposición de color y una imagen a la izquierda. Puede cambiar fácilmente los parámetros del Widget.', 'wpb_widget_domain' );
$csubt = __( '#FFFFFF', 'wpb_widget_domain' );
$baopa = __( '0.9', 'wpb_widget_domain' );
$bacol = __( '#dd9932', 'wpb_widget_domain' );
$tbtnp = __( 'ME GUSTA', 'wpb_widget_domain' );
$ubtnp = __( '#', 'wpb_widget_domain' );
$cbtnp = __( 'btn-primary', 'wpb_widget_domain' );
$ibtnp = __( 'mbri-like', 'wpb_widget_domain' );
$tbtns = __( 'VER DEMO', 'wpb_widget_domain' );
$ubtns = __( 'https://github.com/amilianm/wp-theme-web/', 'wpb_widget_domain' );
$cbtns = __( 'btn-white-outline', 'wpb_widget_domain' );
$ibtns = __( 'mbri-preview', 'wpb_widget_domain' );
$imgin = __( '/assets/images/imgin.jpg', 'wpb_widget_domain' );
...
<p>
<label><strong><?php _e( 'ATRIBUTOS DE LA ÍMAGEN' ); ?></strong></label>
</p>
<p>
<label for="<?php echo $this->get_field_id( 'imgin' ); ?>"><?php _e( 'Imágen de la Intro:' ); ?></label> 
<input class="widefat" id="<?php echo $this->get_field_id( 'imgin' ); ?>" name="<?php echo $this->get_field_name( 'imgin' ); ?>" type="text" value="<?php echo esc_attr( $imgin ); ?>" />
</p>
<p>
...
$instance['imgin'] = ( ! empty( $new_instance['imgin'] ) ) ? strip_tags( $new_instance['imgin'] ) : '';
...
} // Class wpb_widget_ici finaliza aquí